...
export default function NossoTime(){
    return(
        <div className="bg-[#A7A6A0] w-full h-[802px] flex flex-col gap-[80px] py-[108px] mx-auto items-center">
            <div>
                <h2 className="text-center font-bold text-[50px]">Nosso incrível time</h2>
            </div>

            <div className="flex flex-row gap-[200px]">
                <div className="flex flex-col items-center">
                    <img src={MinhaImagem} alt="minha foto" />
                    <h3 className="text-[26px] font-bold">Victor Eduardo</h3>
                    <p className="text-[18px] font-regular">Fundador-CEO</p>
            ...
            <div>
                <p className="text-center text-[20px]">Uma equipe extremamente preparada e capacitada para realizar seus serviços.</p>
            </div>
        </div>
    );
}
